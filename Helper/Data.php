...
class Data extends \Magento\Framework\App\Helper\AbstractHelper 
{
	...
	*/ 
	...
	CONST ENABLE = 'bhavin_productqa/general/enable'; 
	CONST CAPTCHA = 'bhavin_productqa/general/captcha'; 
	CONST QPAGE_SIZE = 'bhavin_productqa/general/qpaze_size'; 
	CONST ANSPAGE_SIZE = 'bhavin_productqa/general/anspaze_size'; 
	CONST MAX_QUESTION_LENGHT = 'bhavin_productqa/general/max_question_lenght'; 
	CONST CONF_SEND_EMAIL = 'bhavin_productqa/general/sendemail'; 
	CONST CONF_SEND_EMAIL_TEMPLATE = 'bhavin_productqa/general/email_template'; 
	CONST CONF_SEND_EMAIL_TEMPLATE_CSS = 'bhavin_productqa/general/email_template_css'; 
	CONST CONF_SEND_EMAIL_SUBJECT = 'bhavin_productqa/general/email_subject'; 
	 /**
	 *	construct
	 *
	...
	{
		return $this->_url->getUrl('bhavin_productqa/variable/template');
    }
	/**
