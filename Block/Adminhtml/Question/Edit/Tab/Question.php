...
class Question extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface {
	...
	protected function _prepareForm() {
		...
		$product_question = $this->_coreRegistry->registry('product_question');
		...
		//$fieldset->addType('customer', 'Bhavin\ProductQA\Block\Adminhtml\Question\Edit\Tab\Renderer\CustomerColumn');
